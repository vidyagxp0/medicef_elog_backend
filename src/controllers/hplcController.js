const hplcForm = require("../models/hplcForm");
const hplcRecord = require("../models/hplcRecords");
...
const hplcAudittrail = require("../models/hplcAuditTrails");
...
exports.InsertHPLC = async (req, res) => {
  const {
    site_id,
    description,
    department,
  ...
  try {
    ...
    const newForm = await hplcForm.create(
      {
        site_id: site_id,
...
exports.EditHPLC = async (req, res) => {
  const {
    form_id,
    site_id,
    description,
...
exports.SendHPElogForReview = async (req, res) => {
...
exports.SendHPElogfromReviewToOpen = async (req, res) => {
...
exports.SendHPfromReviewToApproval = async (req, res) => {
...
exports.SendHPfromApprovalToOpen = async (req, res) => {
...
exports.ApproveHPElog = async (req, res) => {
...
//     switch (type) {
//       case "hplcAudittrail":
//         getData = await hplcAudittrail.findAll({
//           where: { form_id: formId },
//           include: {
//             model: User,
//             attributes: ["user_id", "name"],
