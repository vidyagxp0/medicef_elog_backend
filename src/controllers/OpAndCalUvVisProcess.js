...
const UvVisAuditTrail = require("../models/OpAndCalUvVisAuditTrail");
...
exports.InsertUvVis = async (req, res) => {
  const {
    site_id,
    description,
    department,
  ...
  try {
    ...
    await UvVisAuditTrail.bulkCreate(auditTrailEntries, {
      transaction,
    });
...
exports.EditUvVis = async (req, res) => {
  const {
    form_id,
    site_id,
    description,
  ...
  try {
    ...
    if (validAuditEntries?.length > 0) {
      await UvVisAuditTrail.bulkCreate(validAuditEntries, { transaction });
    }
...
//deleting attachment
exports.deleteUvVisAttachment = async (req, res) => {
...
exports.GetUvVisElog = async (req, res) => {
...
exports.SendUVElogForReview = async (req, res) => {
...
exports.SendUVElogfromReviewToOpen = async (req, res) => {
...
exports.SendUVfromReviewToApproval = async (req, res) => {
...
exports.SendUVfromApprovalToOpen = async (req, res) => {
...
exports.ApproveUVElog = async (req, res) => {
...
exports.getAuditTrailForAnElog = async (req, res) => {
  try {
    ...
    const auditTrail = await UvVisAuditTrail.findAll({
...
//     switch (type) {
//       case "UvVisAuditTrail":
//         getData = await UvVisAuditTrail.findAll({
//           where: { form_id: formId },
//           include: {
//             model: User,
//             attributes: ["user_id", "name"],
